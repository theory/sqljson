...
func (exec *Executor) execMethodSize(
	...
	default:
		if !exec.autoWrap() && !exec.ignoreStructuralErrors {
			// https://github.com/postgres/postgres/blob/REL_18_3/src/backend/utils/adt/jsonpath_exec.c#L1112
...
func (exec *Executor) execMethodBoolean(
	...
	case []any:
		...
		// https://github.com/postgres/postgres/blob/REL_18_3/src/backend/utils/adt/jsonpath_exec.c#L1385
		return exec.returnVerboseError(fmt.Errorf(
...
// https://github.com/postgres/postgres/blob/REL_18_3/src/include/utils/numeric.h#L32-L35
const (
...
func (exec *Executor) executeDecimalMethod(
	...
	// https://github.com/postgres/postgres/blob/REL_18_3/src/backend/utils/adt/numeric.c#L1335-L1339
	...
	if right := node.Right(); right != nil {
		...
		// Verify the scale.
		// https://github.com/postgres/postgres/blob/REL_18_3/src/backend/utils/adt/numeric.c#L1340-L1344
