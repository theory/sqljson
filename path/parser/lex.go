...
func (l *lexer) scanUnicode() rune {
	...
	// https://github.com/postgres/postgres/blob/REL_18_BETA2/src/backend/utils/adt/jsonpath_scan.l#L646-L696
...
func (l *lexer) writeUnicode(r rune) {
	...
	// UTF-16 code point.
	// https://github.com/postgres/postgres/blob/REL_18_BETA2/src/include/mb/pg_wchar.h#L345
...
func (l *lexer) scanHex() rune {
	...
	// https://github.com/postgres/postgres/blob/REL_18_BETA2/src/backend/utils/adt/jsonpath_scan.l#L698-L714
...
// https://github.com/postgres/postgres/blob/REL_18_BETA2/src/backend/utils/adt/jsonpath_scan.l#L552-L573
