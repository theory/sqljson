...
func TestJSONPathString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L3-L30
	t.Parallel()
...
func TestJSONPathEscapesString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L32-L35
	t.Parallel()
...
func TestJSONPathFilterString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L37-L50
	t.Parallel()
...
func TestJSONPathArrayStuffString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L52-L64
	t.Parallel()
...
func TestJSONPathMethodString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L66-L88
	t.Parallel()
...
func TestJSONPathStartsWithString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L90-L91
	t.Parallel()
...
func TestJSONPathRegexString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L93-L103
	t.Parallel()
...
func TestJSONPathMathsString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L105-107
	t.Parallel()
...
func TestJSONPathNumericLiteralsString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L170-205
	t.Parallel()
...
func TestJSONPathNonDecimalString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L207-L223
	t.Parallel()
...
func TestJSONPathUnderscoreNumberString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/src/test/regress/sql/jsonpath.sql#L225-L251
	t.Parallel()
...
func TestJSONPathEncodingString(t *testing.T) {
	// https://github.com/postgres/postgres/blob/REL_17_2/src/test/regress/sql/jsonpath_encoding.sql
	t.Parallel()
